...
if __name__ == "__main__":
    model='internlm2-1-8b' #llama-7b/llama-13b/internlm2-1-8b/internlm2-20b/baichuan-2-13b
    ...
    response=generator.chat_completion(client,model,user_prompt,max_tokens=70)
    print(response)
    # while True:
    #     try:
